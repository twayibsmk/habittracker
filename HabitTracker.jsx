/*
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║              ANTIGRAVITY HABIT TRACKER — SPACE STATION              ║
 * ╠══════════════════════════════════════════════════════════════════════╣
 * ║                                                                      ║
 * ║  SETUP INSTRUCTIONS:                                                 ║
 * ║                                                                      ║
 * ║  1. SUPABASE PROJECT:                                                ║
 * ║     - https://jyrsanijnpcgfwnmznel.supabase.co      ║
 * ║     - sb_publishable_0OH3rsmQG98okxUYS6rEsA_Ty87kO21    ║
 * ║                                                                      ║
 * ║  2. SUPABASE AUTH:                                                   ║
...
const SUPABASE_URL = "YOUR_SUPABASE_URL"; // e.g. https://xyzproject.supabase.co
...
const AICoachingPanel = ({ isOpen, onClose, habits }) => {
  ...
  const fetchCoaching = async () => {
    ...
    const prompt = `You are an expert habit coach embedded in a space-themed habit tracking app called "Antigravity Station". The user has the following habits:
...
export default function HabitTracker() {
  ...
  const signIn = async () => {
    if (!supabase) {
      setAuthError("Supabase not initialized. Check your credentials.");
      return;
    }
    setAuthLoading(true);
    setAuthError(null);
